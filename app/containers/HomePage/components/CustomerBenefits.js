        ...
        <div className="container">
          ...
          <div className="row align-items-center">
            <div className="col-lg-4">
              <h4 className="landing__feature-caption customer_value_title">Book van in no time... just in 3 steps.</h4>
              <div className="customer_benefits_nav">
                <ol id="sw-nav-tools" className="nav nav-process nav-circle nav-justified mt-5 align-items-center">
              ...
              <div className="browser shadow mt-4 mt-md-0" data-aos="fade-left">
                <div className="swiper-container">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide align-items-center"><img src={search} alt="" className="img-responsive" /></div>
