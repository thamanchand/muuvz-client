...
export const ON_PRICE_DELETE = 'app/ResourcePage/ON_PRICE_DELETE';
export const ON_PRICE_DELETE_SUCCESS = 'app/ResourcePage/ON_PRICE_DELETE_SUCCESS';
export const ON_PRICE_DELETE_FAILED = 'app/ResourcePage/ON_PRICE_DELETE_FAILED';

export const ON_RESOURCE_COVER_DELETE = 'app/ResourcePage/ON_RESOURCE_COVER_DELETE';
export const ON_RESOURCE_COVER_DELETE_SUCCESS = 'app/ResourcePage/ON_RESOURCE_COVER_DELETE_SUCCESS';
export const ON_RESOURCE_COVER_DELETE_FAILED = 'app/ResourcePage/ON_RESOURCE_COVER_DELETE_FAILED';

export const ON_VAN_INFO_UPDATE = 'app/ResourcePage/ON_VAN_INFO_UPDATE';
export const ON_VAN_INFO_UPDATE_SUCCESS = 'app/ResourcePage/ON_VAN_INFO_UPDATE_SUCCESS';
export const ON_VAN_INFO_UPDATE_FAILED = 'app/ResourcePage/ON_VAN_INFO_UPDATE_FAILED';
